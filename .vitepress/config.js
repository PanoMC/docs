            ...
            items: [
              ...
              { text: "Installation", link: "/platform/installation/" },
              {
                ...
                items: [
                  ...
                  { text: "Usage Data", link: "/platform/configuration/telemetry/" },
                ],
              },
              {
                text: "Integrations",
              ...
              },
              {
                ...
                collapsed: true,
                items: [
                  { text: "Server Pages", link: "/platform/server-management/server-pages/" },
                  { text: "Managed Servers", link: "/platform/server-management/managed-servers/" },
                  { text: "Permissions & Alerts", link: "/platform/server-management/permissions/" },
            ...
            items: [
              ...
              { text: "Kurulum", link: "/tr/platform/installation/" },
              {
                ...
                items: [
                  ...
                  { text: "Kullanım Verileri", link: "/tr/platform/configuration/telemetry/" },
                ],
              },
              {
                text: "Entegrasyonlar",
              ...
              },
              {
                ...
                collapsed: true,
                items: [
                  { text: "Sunucu Sayfaları", link: "/tr/platform/server-management/server-pages/" },
                  { text: "Yönetilen Sunucular", link: "/tr/platform/server-management/managed-servers/" },
                  { text: "İzinler ve Uyarılar", link: "/tr/platform/server-management/permissions/" },
            ...
            items: [
              ...
              { text: "Установка", link: "/ru/platform/installation/" },
              {
                ...
                items: [
                  ...
                  { text: "Данные об использовании", link: "/ru/platform/configuration/telemetry/" },
                ],
              },
              {
                text: "Интеграции",
              ...
              },
              {
                ...
                collapsed: true,
                items: [
                  { text: "Страницы сервера", link: "/ru/platform/server-management/server-pages/" },
