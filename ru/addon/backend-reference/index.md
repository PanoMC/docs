...
Полный, компилирующийся запрос — настоящий `SELECT` и `INSERT`, написанные внутри DAO, — см. на странице руководства [База данных и миграции](/ru/addon/database/#реализация).
