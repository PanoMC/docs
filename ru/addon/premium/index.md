...
Премиум сейчас доступен только аккаунтам с **доступом к панели** на panomc.com — как и [freemium](/ru/addon/freemium/), и для дополнений, и для тем. Продажа в маркетплейсе сторонним авторам пока не открыта, поэтому на шаге выбора цены оба варианта отключены, а API отклоняет их для всех остальных. Эта страница описывает, как работает премиум, чтобы вы могли планировать; пока программа не открыта, публикуйте дополнение бесплатным.
:::
