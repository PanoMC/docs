...
- **База данных**: Актуальная версия MariaDB/MySQL (MariaDB 10.6+ / MySQL 8+)
...
2. **Настройте окружение**: Убедитесь, что у вас установлена JDK 17+ (тесты выполняются на JDK 21) и запущена актуальная версия MariaDB/MySQL.
