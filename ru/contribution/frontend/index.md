...
- **vanilla-theme**: Встроенная эталонная (системная) тема, поставляемая вместе с Pano. Это **не** стартовый шаблон — новые темы создаются командой `bunx @panomc/theme-core new`.
