...
описанными в разделе [Конфигурация](configuration/). Вся модель — изоляция, обновления и резервные
копии — описана в разделе [Хостинг Pano Instance для других](../hosting/).
