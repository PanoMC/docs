...
| **Запущенный Pano** | Ваш собственный сервер Pano или запущенный на вашем компьютере — сначала Pano должен быть установлен и запущен; если вы его ещё не настроили, см. [Установку](/ru/platform/installation/). Ваша тема общается с ним во время работы. |
...
Ещё один шаг на стороне Pano: откройте файл конфигурации Pano, отключите настройку `init-ui` и перезапустите Pano. Это говорит Pano использовать **вашу** тему в разработке вместо запуска собственной встроенной. Где находится эта настройка — см. страницу [Конфигурация сервера](/ru/platform/configuration/server/#инициализация-ui-и-обновления).
