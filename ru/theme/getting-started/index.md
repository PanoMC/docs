...
Ещё один шаг на стороне Pano: откройте файл конфигурации Pano, отключите настройку `init-ui` и перезапустите Pano. Это говорит Pano использовать **вашу** тему в разработке вместо запуска собственной встроенной. Где находится эта настройка — см. страницу [Конфигурация сервера](/ru/platform/configuration/server/).
