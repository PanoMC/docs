# FAQ (Sıkça Sorulan Sorular) Eklentisi
...
- **Kategorizasyon:** "Genel", "Sunucu Kuralları", "Bağışlar" gibi kategoriler oluşturun.
- **Görüntüleme Sırası:** Kategorilerin sırasını kontrol edin.
- **Durum:** Bir kategorinin tamamının görünürlüğünü kolayca açıp kapatın.

### 2. SSS Yönetimi
Bireysel soru ve cevapları yönetin.
- **Zengin Metin Desteği:** Yerleşik editörü kullanarak detaylı yanıtlar yazın.
- **Sıralama:** Her soru için kategorisi içinde özel bir görüntüleme sırası belirleyin.
- **Aktif Durum:** Belirli SSS'leri silmeden etkinleştirin veya devre dışı bırakın.
